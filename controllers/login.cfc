<cfcomponent>
	...
	<cffunction name="init" hint="store the fw"
	...
	<cffunction name="before" hint="if logged in and NOT asking to logout, redirect to main"
		access="public" output="no" returntype="void">
	...
	<cffunction name="login" hint="stub this for now"
		access="public" returntype="void">
		<cfargument name="rc" type="struct" required="yes" />
		...
		<!--- does this make *any* sense here for use with CAS; I don't think so --->
	...
	<cffunction name="logout" hint="reset the session variables"
		access="public" returntype="void">
		<cfargument name="rc" type="struct" required="yes" />
